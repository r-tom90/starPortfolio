...
function Technology_tag({ data }: Props) {
  return (
    <div className="w-full h-auto flex flex-row items-center flex-wrap mt-[10px] ">
      ...
      <div
        className={`tag ${
          data.technology_feature.includes("ThreeJS") ? "" : " hidden"
        }  bg-[#FFF1]    text-[#FFFEEE] `}
      >
        ThreeJS
      </div>
      ...
      <div
        className={`tag ${
          data.technology_feature.includes("NextJS 13") ? "" : " hidden"
      ...
      >
        ...
        <span className=" text-[#EE0156]">Token</span>
      </div>
      <div
        className={`tag ${
